...
#section3_2layerNN
#!!! The result I finally submitted on oj is using "train.py" and "submit.py", not this 2layerNN one.
...
class Network():
    ...
    def calc_gradient(self, label):
        ...
        out_delta = self.layers[1].activator.backward(self.layers[1].y) * (label - self.layers[1].y)
